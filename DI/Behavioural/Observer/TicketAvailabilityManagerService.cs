...
{
    public class TicketAvailabilityManagerService: ITicketchangeListner
    {
        public TicketAvailabilityManagerService(TicketChangeNotifier notifier)
        {
            notifier.Subscribe(this);
        }
        public void ReceiveNotification(TicketChange ticketChange)
        {
            Console.WriteLine($"Data changed ArtistId{ticketChange.ArtistId}");
